...
animals_samples_en<-  
  ...
  dplyr::mutate(attr_def=
                  c(
                    ...
                    "A text field to register the anomalies in the animal observed at the Event that are not present in the 'Anomalies in Sick, Injured, or Dead Animals' Attribute", 
