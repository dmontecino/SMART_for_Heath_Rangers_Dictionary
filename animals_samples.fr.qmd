...
animals_samples_fr<-  
  ...
  dplyr::mutate(attr_def=
                  c(
                    ...
                    rep("The species of the animal observed at the Incident", nrow(fr[fr$att_key=="species_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    
                    rep("A text field to provide the species of the animal observed at the Incident if it is not given in the 'Species' Attribute", nrow(fr[fr$att_key=="providespeciesnotlisted_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    
                    rep("The code to identify the animal observed at the Incident individually", nrow(fr[fr$att_key=="animalid_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    
                    rep("The captivity category of the animal observed at the Incident", nrow(fr[fr$att_key=="captivitycategory_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    
                    rep("The health condition in which the animal is found at the Incident", nrow(fr[fr$att_key=="conditionfound_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    
                    rep("The age of the animal observed at the Incident", nrow(fr[fr$att_key=="ageofanimal_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    
                    rep("The sex of the animal observed at the Incident", nrow(fr[fr$att_key=="sexofanimal_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    
                    rep("The anomalies in the animal observed at the Incident. Multiple options can be selected", nrow(fr[fr$att_key=="anomaliesinsickinjuredordeadanimals_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    ...
                    rep("The potential cause of death, disease, or injury in the animal observed at the Incident. Multiple options can be selected", nrow(fr[fr$att_key=="suspectcauseofdeathdiseaseorinjury_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    
                    rep("Answer to the question 'was the carcass of the animal observed at the Incident collected?", nrow(fr[fr$att_key=="wasthecarcasscollected_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    
                    
                    rep("The code to identify each sample collected from the animal observed at the Incident individually", nrow(fr[fr$att_key=="sampleid_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    
                    rep("The type of sample collected from the animal observed at the Incident", nrow(fr[fr$att_key=="sampletype_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    
                     rep("Answer to the question 'was the sample collected directly from the animal observed at the Incident?'", nrow(fr[fr$att_key=="wasthecarcasscollected_whn" & fr$cat_key_level_1=="animalandsamples_whn",])),
                    
                    rep("A text field to provide any other relevant information regarding the sample collected from the animal observed at the Incident", nrow(fr[fr$att_key=="otherrelevantinformation_whn" & fr$cat_key_level_1=="animalandsamples_whn",])))) 
