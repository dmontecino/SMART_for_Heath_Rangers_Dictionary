...
livestock_es<-  
  ...
  dplyr::mutate(attr_def=
                  c(
                    ...
                    rep("La especie de ganado o doméstica observada en el Incidente", nrow(en[en$att_key=="livestockdomesticspecies_whn" & en$cat_key_level_1=="livestockdomesticspecies_whn",])),
