...
```{r Site Description, echo=FALSE, eval=T, message=FALSE, cache=T}
...
site_description_en<-  
  ...
  dplyr::mutate(Definition=
                  c(
                  rep("Select one or more items that are present at the Incident. If there are other relevant features at the Incident not provided in the options that could have disease implications, it is possible to select the option 'Other Findings' and a text box will pop-up to describe them", 
