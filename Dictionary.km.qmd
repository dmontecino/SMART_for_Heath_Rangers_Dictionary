...
animals_samples_km<-  
  ...
  dplyr::mutate(attr_def=
                  c(
                    ...
                    rep("The condition of the dead animal found at the Event. Select one option", nrow(kh[kh$att_key=="conditiondeadanimals_whn" & kh$cat_key_level_1=="animalandsamples_whn",])),
                    ...
                    rep("The potential cause of death, disease, or injury in the animal observed at the Event. Multiple options can be selected", nrow(kh[kh$att_key=="potentialcauseofdeathdiseaseorinjury_whn" & kh$cat_key_level_1=="animalandsamples_whn",])),
                  ...
                  rep("Answer to the question 'was the sample collected directly from the animal observed at the Event?'", nrow(kh[kh$att_key=="collecteddirectlyfromanimal_whn" & kh$cat_key_level_1=="animalandsamples_whn",])),
