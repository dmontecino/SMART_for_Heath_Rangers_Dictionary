...
The description of Attributes, Sub-Attributes, and Options across the Categories used in SMART for Health is provided in the data dictionary accessible [here](https://dmontecino.github.io/SMART_for_Heath_Rangers_Dictionary/Dictionary.html).
