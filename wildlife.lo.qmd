...
wildlife_lo<-  
  ...
  dplyr::mutate(attr_def=
                  c(
                    ...
                    rep("Add definition 4", nrow(lo[lo$att_key=="numberhealthy_whn" & lo$cat_key_level_1=="wildlife_whn",])),
                    
                    rep("Add definition 5", nrow(lo[lo$att_key=="numbersickorinjured_whn" & lo$cat_key_level_1=="wildlife_whn",])),
                    ...
                    rep("Add definition 9", nrow(lo[lo$att_key=="numberdead_whn" & lo$cat_key_level_1=="wildlife_whn",])),
                    
                    
                    rep("Add definition 10", nrow(lo[lo$att_key=="conditiondeadanimals_whn" & lo$cat_key_level_1=="wildlife_whn",])),
                   ...
                   rep("Add definition 12", nrow(lo[lo$att_key=="otheranomaliesdead_whn" & lo$cat_key_level_1=="wildlife_whn",])),
                    ...
                    rep("Add definition 15", nrow(lo[lo$att_key=="otherrelevantinformation_whn" & lo$cat_key_level_1=="wildlife_whn",])))) 
